    ...
    (() => {
      ...
      class x {
        ...
        parseHandshakeResponse(t) {
          ...
          if (y(t)) {
            ...
            const r = n + 1;
            ((e = i.substring(0, r)),
              (s = i.length > r ? i.substring(r) : null));
          }
          const i = D.parse(e),
            n = JSON.parse(i[0]);
          if (n.type)
      ...
      class N {
        ...
        ut(t) {
          ...
          return (
            this.u.log(e.Debug, "Server handshake complete."),
            this.X(),
            i
          );
        }
        ...
        async bt(t) {
          ...
          (this.u.log(
            e.Information,
            `Reconnect retries have been exhausted after ${Date.now() - s} ms and ${i} failed attempts. Connection disconnecting.`,
          ),
            this.it());
        }
        vt(t, s, i) {
          ...
          ((this.H = {}),
            Object.keys(s).forEach((i) => {
              ...
              try {
                ...
                this.u.log(
                  e.Error,
                  `Stream 'error' callback called with '${t}' threw error: ${P(s)}`,
                );
              }
            }));
        }
                ...
                204 === r.statusCode
                  ...
                  : 200 !== r.statusCode
                    ...
                    : r.content
                      ? (this.u.log(
                          e.Trace,
                          `(LongPolling transport) data received. ${m(r.content, this.Ht.logMessageContent)}.`,
                        ),
                  ...
                  ((r.onmessage = (t) => {
                    if (this.onreceive)
                      try {
                        (this.u.log(
                          e.Trace,
                          `(SSE transport) data received. ${m(t.data, this.Ht.logMessageContent)}.`,
                        ),
              ...
              (o || (o = new this.qt(t)),
                ...
                (o.onmessage = (t) => {
                  if (
                    (this.u.log(
                      e.Trace,
                      `(WebSockets transport) data received. ${m(t.data, this.jt)}.`,
                    ),
                    this.onreceive)
                  )
                    try {
          ...
          for (const i of a) {
            ...
            if (a instanceof Error)
              ...
              try {
                return (
                  await this.Yt(o, n),
                  void (this.connectionId = u.connectionId)
                );
              } catch (t) {
                if (
                  (this.u.log(
      ...
      class V {
        ...
        de(t) {
          if (this.oe.length && typeof this.oe[0] != typeof t)
            throw new Error(
              `Expected data to be of type ${typeof this.oe} but was of type ${typeof t}`,
            );
